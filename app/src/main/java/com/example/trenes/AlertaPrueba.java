 ...
 * helper methods.
 */
public class AlertaPrueba extends IntentService {
    ...
    public static void startActionFoo(Context context, String param1, String param2) {
        Intent intent = new Intent(context, AlertaPrueba.class);
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
          ...
          //  Response<AlertaResponse> Respuesta= General.AlertaRamal(General.ID_Sarmiento);
            //Log.e(Objects.requireNonNull(Respuesta.body()).nombre,Respuesta.body().nombre);
//            Log.e(General.AlertaRamal().body().nombre,General.AlertaRamal().body().alertas.get(0).mensaje);
            Log.e("MIRA","ENTRO BIEN");
        } catch (IOException e) {
            e.printStackTrace();
            Log.e("MIRA","ERROR WEB");
        }
        Log.e("MIRA","ENTRO TAREA");
//        General.GeneracionToken();
    }
